...
public class NavigationBar extends RelativeLayout {
    ...
    public void init() {
        ...
        //设置控件Z轴高度
        this.setElevation(ConvertUtils.dip2px(getContext(), 4));
...
//        layoutParams.topMargin = (int) getResources().getDimension(R.dimen.activity_navigationbar_maringtop);
        ...
        leftLayoutParams.topMargin = (int) getResources().getDimension(R.dimen.activity_navigarionbar_back_margintop);
//        leftLayoutParams.topMargin = ConvertUtils.dip2px(getContext(), 10);
        leftBarLayout.setLayoutParams(leftLayoutParams);
        leftBarLayout.setMinimumWidth(ConvertUtils.dip2px(getContext(), 15));
        leftBarLayout.setGravity(Gravity.CENTER_VERTICAL);


        LayoutParams middleLayoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        middleLayoutParams.topMargin = (int) getResources().getDimension(R.dimen.activity_navigarionbar_title_margintop);
        ...
        rightLayoutParams.setMargins(0, (int) getResources().getDimension(R.dimen.activity_navigarionbar_title_margintop)
                , 0, ConvertUtils.dip2px(context, 15f));
...
//        canvas.drawLine(0,canvas.getHeight() - 1 ,canvas.getWidth(),canvas.getHeight() - 1,paint);
    ...
    public void setTitle(CharSequence text) {
        ...
        title = text;
        titleView.setEms(1);
//        titleView.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));//加粗
